...
fun Application.routing() {
    ...
    routing {
        ...
        get("/health") {
            call.respondText(
                """{"status":"healthy","database":true,"dbType":"PostgreSQL"}""",
        ...
        get("/db/status") {
            call.respondText(
                """{"connected":true,"type":"PostgreSQL"}""",
                ContentType.Application.Json,
                HttpStatusCode.OK
            )
        }
        ...
        /**
         * Serve React frontend from static resources
         * This serves the built React app for the UI
         */
